...
description: Panduan desain UI khas untuk SIPASTLOG; hindari kesan generik dan template default. Fokus pada tipografi, warna, layout spesifik logistik pemerintah BPBD.
license: Apache-2.0; lihat LICENSE.txt untuk syarat lengkap.
source: https://github.com/anthropics/skills
version: "1.0.0"
---

# Frontend Design — Adaptasi untuk SIPOSTLOG

Pendekatan sebagai desainer UI utama yang memberikan identitas visual khas. Fokus pada dashboard logistik pemerintah BPBD, bukan e-commerce atau SaaS umum. Hindari pilihan desain generik seperti:
- Accent single word in headline
- Using all caps for labels  
- Numbered markers (01/02/03) tanpa keperluan sequence
